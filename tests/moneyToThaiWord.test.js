...
test('Baht and Satang edge cases', t => {
  const moneys = [
    { n: 20.001, w: 'ยี่สิบบาทถ้วน' },
    { n: 20.0001, w: 'ยี่สิบบาทถ้วน' },
    { n: 20.0011111, w: 'ยี่สิบบาทถ้วน' },
    { n: 20.0111111, w: 'ยี่สิบบาทหนึ่งสตางค์' },
    { n: 20.0199999, w: 'ยี่สิบบาทสองสตางค์' },
    { n: 20.991, w: 'ยี่สิบบาทเก้าสิบเก้าสตางค์' },
    { n: 20.9949999, w: 'ยี่สิบบาทเก้าสิบเก้าสตางค์' },
    { n: 20.995, w: 'ยี่สิบเอ็ดบาทถ้วน' },
    { n: 20.9999999, w: 'ยี่สิบเอ็ดบาทถ้วน' },
  ];
  moneys.forEach(m => {
    t.is(moneyToThaiWord(m.n), m.w);
  });
